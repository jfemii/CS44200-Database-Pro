...
const ProductCustomizer = () => {
    ...
    console.log('ProductCustomizer rendered, selectedColor:', selectedColor);
    console.log('TSHIRT_IDS[selectedColor]:', TSHIRT_IDS[selectedColor]);
    ...
    return (
        <div>
            ...
            <ReviewSection itemId={TSHIRT_IDS[selectedColor]} />
        </div>
    );
};
